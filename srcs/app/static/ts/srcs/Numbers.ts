export interface ScoreData{
    ...
    right?: number; 
    left_player?: string,
    left_pseudo?: string | null, 
    right_player?: string, 
    right_pseudo?: string | null, 
    canvas_id: string
}
...
export class Numbers {
    ...
    private left_player: string;
    private right_player: string;
    ...
    constructor(scoreData: ScoreData) {  
        ...
        this.canvas = document.getElementById(scoreData.canvas_id) as HTMLCanvasElement | null;
        if (!this.canvas) {
    ...
    update(scoreData: { left: number; right: number }) {
