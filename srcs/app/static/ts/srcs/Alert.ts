...
import { userHandler, USER_ACTION } from "./handlers";
import { register_game } from "./handlers";
import { decline_chat_game } from "./Chat";
...
export class Alert extends HTMLElement
{
    ...
    constructor()
    {
        ...
        let ok_action = this.getAttribute("ok_action") as keyof typeof USER_ACTION;
        let cancel_action = this.getAttribute("cancel_action") as keyof typeof USER_ACTION;
        let handler  = this.getAttribute("handler") as keyof typeof ALERT_ACTIONS;
        let alt_handler = null;
        if (this.getAttribute("alt-handler"))
            alt_handler = this.getAttribute("alt-handler") as keyof typeof ALERT_ACTIONS;
        let user = this.getAttribute("user");
        let friend : string = this.getAttribute("friend") as string;
