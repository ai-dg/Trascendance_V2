...
export function resetElement(element: HTMLElement, maxToKeep:number = 0, keep:string = FIRST) {
    if (maxToKeep < 0)
        return
    if (keep === FIRST)
    {
...
export function editElement(element:HTMLElement) {
