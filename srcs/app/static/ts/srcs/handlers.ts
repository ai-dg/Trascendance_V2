 ...
 */
export async function userHandler(user:string, operation:UserAction)
{
    let action = "none";
    ...
    else (console.error("Wrong action type !"))
}


export function register_game(user:string, operation:UserAction, game:any)
{
