...
//         //         console.log("Connected! Re-attaching listeners");
...
//         console.log("Socket ID:", this.generalSocket.id);
//         console.log("Socket connected?", this.generalSocket.connected);


//         this.generalSocket.onAny((event, data) => {
