...
export async function showUpdateProfile(text) {
    ...
    getElement('changeUsernameBtn')?.addEventListener('click', async () => {
    ...
    getElement('changeEmailBtn')?.addEventListener('click', async () => {
    ...
    getElement('changePasswordBtn')?.addEventListener('click', async () => {
        const passwdInput = getElement('passwd');
        const passwdInputConfirm = getElement('passwd');
