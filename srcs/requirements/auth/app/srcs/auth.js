import { redis, server } from '../server.js'
...
export async function confirm_email_token(token)
{
	...
	const query_result = await server.db.query(`INSERT INTO users (user_mail, user_password, pseudo) VALUES (?, ?, ?)`,	[email, passwordHash, pseudo]);
